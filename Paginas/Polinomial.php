...
<body background="static/inicio.jpg">
    <div class="container" >
        ...
        <div class="card">
            <div class="card-header text-white bg-danger">
                <h1 class="display-1 text-center">Regresion Polinomial</h1>
    ...
    <div class="container" style="text-align: center;">
        <img src="static/regresion_polinomial.jpg">
    </div>
    <br><br>
    <div class="container" style="text-align: center;">
        <label>Escriba el campo del eje x: </label>
        ...
        <br><br>
        <label>Escriba el numero de prediccion: </label>
        <input id="cuadroP" type="text" name="tipo_de_dato"/>
        <br><br>
        <label>Escriba grado del polinomio (numero entero): </label>
        <input id="cuadroG" type="text" name="tipo_de_dato"/>
        <br><br>
        <button onclick="GenerarRegresion()">Enviar</button>
    </div>
    <br><br>
    <div class="container" style="text-align: center;">
        <img src="static/Regresion_Polinomial.png">
    </div>
    <footer class="footer">
        <div class="container">
...
<script>
        function GenerarRegresion(){
            ...
            var ruta = 'https://olc2-p2-201907636-backend.herokuapp.com/RegresionPolinomial'
            let json = JSON.stringify({
                eje_x: document.getElementById("cuadroX").value,
                eje_y: document.getElementById("cuadroY").value,
                prediccion: document.getElementById("cuadroP").value,
                grado: document.getElementById("cuadroG").value
            })
            document.getElementById("cuadroX").value = "";
            document.getElementById("cuadroY").value = "";
            document.getElementById("cuadroP").value = "";
            document.getElementById("cuadroG").value = "";
            xhr.open("POST", ruta)
