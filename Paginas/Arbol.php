...
<body background="static/inicio.jpg">
    <div class="container" >
        ...
        <div class="card">
            <div class="card-header text-white bg-danger">
                <h1 class="display-1 text-center">Clasificador de árboles de decisión</h1>
    ...
    <div class="container" style="text-align: center;">
        <img src="static/asrbol.jpg">
    </div>
    <br><br>
    <div class="container" style="text-align: center;">
        <label>Escriba el campo a hacer la predriccion: </label>
        <input id="cuadroCampo" type="text" name="tipo_de_dato"/>
        <br><br>
        <label>Escriba el rango de columnas: </label>
...
<script>
        function GenerarRegresion(){
            ...
            var ruta = 'https://olc2-p2-201907636-backend.herokuapp.com/ArbolDecision'
            let json = JSON.stringify({
                prediccion: document.getElementById("cuadroCampo").value,
