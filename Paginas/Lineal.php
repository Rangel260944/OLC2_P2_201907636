...
<body background="static/inicio.jpg">
    <div class="container" >
        ...
        <div class="card">
            <div class="card-header text-white bg-danger">
                <h1 class="display-1 text-center">Regresion Lineal</h1>
    ...
    <div class="container" style="text-align: center;">
        <img src="static/regresion_lineal.jpg">
    </div>
    <br><br>
    <div class="container" style="text-align: center;">
...
<script>
        function GenerarRegresion(){
            ...
            var ruta = 'https://olc2-p2-201907636-backend.herokuapp.com/RegresionLineal'
